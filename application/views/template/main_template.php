                    ...
                    <div class="pull-right">
                        <div class="chat-toggler"> <a href="#" class="dropdown-toggle" id="my-task-list" data-placement="bottom"  data-content='' data-toggle="dropdown" data-original-title="Notifications">
                                <div class="user-details">
                                    <div class="username" id="user-name"> <!--<span id="notification-count" class="badge badge-important"></span>--> <?php echo ucfirst($this->session->userdata('USER_FNAME')); ?> &nbsp&nbsp; </div>
                                </div>
...
<!--                    <div class="side-bar-widgets">
            ...
            <script src="<?php echo base_url(); ?>application_resources/custom_js/custom_trains.js" type="text/javascript"></script>
           <script src="<?php echo base_url(); ?>application_resources/custom_js/custom_new_user.js" type="text/javascript"></script>
...
<!--            <script src="<?php echo base_url(); ?>application_resources/js/jszip.js" type="text/javascript"></script>
   ...
   <script src="<?php echo base_url(); ?>application_resources/js/CSVParser.js" type="text/javascript"></script>
            ...
            <script src="<?php echo base_url(); ?>application_resources/js/visualization.js" type="text/javascript"></script>

            <!-- END PAGE LEVEL PLUGINS -->
            <!-- BEGIN CORE TEMPLATE JS -->
            <script src="<?php echo base_url(); ?>application_resources/js/core.js" type="text/javascript"></script>
            <script src="<?php echo base_url(); ?>application_resources/js/coordinates.js" type="text/javascript"></script>
...
<!--            <script src="<?php echo base_url(); ?>application_resources/file_upload_plugin/ajaxupload.3.5.js" type="text/javascript"></script>-->
            ...
            <!--<script src="<?php echo base_url(); ?>application_resources/jupload/js/coordinates.js"></script>-->
